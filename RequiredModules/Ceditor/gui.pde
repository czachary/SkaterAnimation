...
//  if(key=='`') picking=true; 
  ...
  if(key=='A') {showSkater=!showSkater;}
...
void displayHeader()  // Displays title and authors face on screen
    ...
    fill(white); image(myFace, width-myFace.width/3,25,myFace.width/3,myFace.height/3); 
    }
...
String title ="CS 3451 - Fall 2016 - Project 4", name ="Christina Zachary",
